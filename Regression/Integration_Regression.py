...
# Naver = 788, 800:6364
train_data = pd.read_csv('C:/Users/khw08/Desktop/OSBAD_Project/Regression/KoNLPY_Youtube_M&D_train_CSV.csv')
#youtube = 1072, 1073:21550
# train_data = pd.read_csv('C:/Users/khw08/Desktop/OSBAD_Project/Regression/KoNLPY_Twitter_M&D_train_CSV.csv')
#Twitter = 1000, 1001:8000
x_train = []
y_train = []
predictors = []
...
d_x_train = d_x_2.loc[:1000, :]
d_y_train = d_y.loc[:1000, :]
...
m_x_train = m_x_2.loc[:1000, :]
m_y_train = m_y.loc[:1000, :]
...
def Reg_coef(var, a):
    ...
    print('하위 15 단어')
    print(coef_pre.head(n=15))
    print('상위 15 단어')
    print(coef_pre.tail(n=15))
