...
def main():
    # 생성 테스트 파일
    read_file = 'Sentiment/Sentiment_twitter/Data/Input/test_crawling_data.txt'
    create_json_file = 'Sentiment/Sentiment_twitter/Data/Output/create_test_json.json'
    create_model_name = 'Data/Test/Output/create_test_model.h5'

    # 실제 분석 테스트 파일
    test_json_file = 'Sentiment/Sentiment_twitter/Data/Input/analyze_test_json.json'
    test_model_name = 'Data/Test/Input/analyze_test_model.h5'
    analyze_data_file = 'Sentiment/Sentiment_twitter/Data/Input/analyze_test_data.txt'
    analyze_result_file_txt = 'Sentiment/Sentiment_twitter/Data/Output/analyze_result.txt'
    analyze_result_file_csv = 'Sentiment/Sentiment_twitter/Data/Output/analyze_result.csv'
